const Ch1Questions = [
    {
      ...
      answers: [
          ...
          {text: 'The ability to store values and pull values out of variables', id: 2},
    ...
    {
      question: 'In a traditional compiled-language process, what is the correct order of the three main steps a programwill undergo before executing?',
      orderedById: true,
      answers: [
    ...
    },
    {
      ...
      answers: [
          ...
          {text: 'Collecting and maintaining a look-up list of all declared variables ', id: 1},
          {text: 'Start-to-Finish compilation and execution of the javaScript prgoram', id: 2},
          {text: 'Taking a stream of tokens and turning it into a tree of nested elements', id: 3}
      ],
      correctAnswerId: 1,
